...
def upgrade():
    ...
    op.create_index(op.f('ix_alert_definitions_id'), 'alert_definitions', ['id'], unique=False)
    ...
    op.create_table('alerts',
        ...
        sa.ForeignKeyConstraint(['definition_id'], ['alert_definitions.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
